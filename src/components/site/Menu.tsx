...
<img className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" alt="Towering crispy golden cone Mylapore Ney Ghee Roast Dosa served on banana leaf with brass katoris of coconut chutney, tomato chutney, mint chutney, and steaming piping hot drumstick sambar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDHifZMmbWDSbXTtGnmnrSN0CyqWAOd2CCC2W585YBGl8yMDxcyAq9viBrmJaZb3CzBN65UuaMKFCCU_oYzVxkb953UDIJQ--fT4Nk8J8-EOe_ZJdTx4zIjOv7bpFYDlPkXPCOBuSg69StpkfvspK1yAlSa9yo5zrgjeSkF1huL3oaRBN8UUuXBkqIebtLXjNh9ksHiPi0jHwcz9SfkuAf2MVJROzLtKguEQatVhGIqNdDIH53lS0ul" />
...
<div>
<div className="relative h-56 overflow-hidden">
<img className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" alt="Chettinad Anjappar black pepper chicken roast garnished with fried curry leaves, whole toasted peppercorns, and caramelized baby shallots in a traditional heavy cast-iron kadai" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAQdm0B8DYQlH1S_te9T-SdoCmDHDB6eLxC7M9QuZ_sYmN8VH2_k-ZettM45ZYEd9NUXbZMUTVC7v-_Jck-MVAk6591JB2GtWvQe6ArRpME-O3uhT82jVi1RjOtHfmXfmEqGEPpqQANbQxk407BsQ3khUDAFukEvjuqxDfdghRDYRJYrbaB7MkvK30f1gZlGKGEYhIMJ6U3mO4OQBzT9Ju6mnB7sLS_XEIIoY6mxLmxs_R4PZts0Fyg" />
<div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-black/45 via-black/10 to-transparent"></div>
<div className="absolute top-3 left-3 flex gap-1.5">
