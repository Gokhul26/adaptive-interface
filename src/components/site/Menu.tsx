...
<button className="menu-filter-btn px-4 py-2 rounded text-label-md font-label-md uppercase transition-all bg-primary text-on-primary shadow-sm" data-filter="all" onClick={() => filterDishes('all')}>All Specialties</button>
<button className="menu-filter-btn px-4 py-2 rounded text-label-md font-label-md uppercase transition-all text-on-surface hover:bg-surface-container-high" data-filter="tiffin" onClick={() => filterDishes('tiffin')}>Breakfast Tiffin</button>
<button className="menu-filter-btn px-4 py-2 rounded text-label-md font-label-md uppercase transition-all text-on-surface hover:bg-surface-container-high" data-filter="feast" onClick={() => filterDishes('feast')}>Elai Saapaadu</button>
<button className="menu-filter-btn px-4 py-2 rounded text-label-md font-label-md uppercase transition-all text-on-surface hover:bg-surface-container-high" data-filter="roast" onClick={() => filterDishes('roast')}>Gravies & Roasts</button>
<button className="menu-filter-btn px-4 py-2 rounded text-label-md font-label-md uppercase transition-all text-on-surface hover:bg-surface-container-high" data-filter="kaapi" onClick={() => filterDishes('kaapi')}>Kaapi & Sweets</button>
</div>
</div>

<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-lg" id="dishes-grid">

<div className="dish-item bg-surface rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between" data-category="tiffin">
<div>
...
<span className="px-2 py-1 bg-tertiary text-on-tertiary rounded text-label-sm font-label-sm font-semibold flex items-center gap-1">
<span className="w-2 h-2 rounded-full bg-tertiary-fixed"></span> Veg
                </span>
<span className="px-2 py-1 bg-secondary-container text-on-secondary-container rounded text-label-sm font-label-sm font-bold flex items-center gap-1">
                  👑 Signature
                </span>
</div>
<div className="absolute bottom-3 right-3 bg-surface/90 backdrop-blur px-2.5 py-1 rounded text-primary font-headline-sm font-bold text-headline-sm">
                ₹180
              </div>
</div>
...
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('dosa')}>
...
<div className="dish-item bg-surface rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between" data-category="roast">
<div>
<div className="relative h-56 overflow-hidden">
...
<div className="absolute top-3 left-3 flex gap-1.5">
<span className="px-2 py-1 bg-primary text-on-primary rounded text-label-sm font-label-sm font-semibold flex items-center gap-1">
                  🍗 Non-Veg
                </span>
...
<div className="px-space-lg pb-space-lg pt-space-xs flex items-center justify-between border-t border-outline-variant/20">
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('pepper')}>
<span className="material-symbols-outlined text-[16px]">history_edu</span> Origins
            </button>
<a className="px-space-md py-1.5 bg-primary hover:bg-primary-container text-on-primary rounded text-label-sm font-label-sm uppercase transition-colors" href="#reservation-section">
              Order at Table
...
<div className="px-space-lg pb-space-lg pt-space-xs flex items-center justify-between border-t border-outline-variant/20">
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('kari')}>
<span className="material-symbols-outlined text-[16px]">history_edu</span> Origins
            </button>
<a className="px-space-md py-1.5 bg-primary hover:bg-primary-container text-on-primary rounded text-label-sm font-label-sm uppercase transition-colors" href="#reservation-section">
              Order at Table
...
<div className="dish-item bg-surface rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between" data-category="feast">
<div>
<div className="relative h-56 overflow-hidden">
...
<div className="px-space-lg pb-space-lg pt-space-xs flex items-center justify-between border-t border-outline-variant/20">
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('feast')}>
<span className="material-symbols-outlined text-[16px]">history_edu</span> Origins
            </button>
<a className="px-space-md py-1.5 bg-primary hover:bg-primary-container text-on-primary rounded text-label-sm font-label-sm uppercase transition-colors" href="#reservation-section">
              Reserve Feast
...
<div className="dish-item bg-surface rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between" data-category="kaapi">
<div>
<div className="relative h-56 overflow-hidden">
...
<div className="px-space-lg pb-space-lg pt-space-xs flex items-center justify-between border-t border-outline-variant/20">
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('kaapi')}>
<span className="material-symbols-outlined text-[16px]">history_edu</span> Origins
            </button>
<a className="px-space-md py-1.5 bg-primary hover:bg-primary-container text-on-primary rounded text-label-sm font-label-sm uppercase transition-colors" href="#reservation-section">
              Order at Table
...
<div className="px-space-lg pb-space-lg pt-space-xs flex items-center justify-between border-t border-outline-variant/20">
<button className="text-label-sm font-label-sm uppercase text-secondary hover:text-primary font-semibold flex items-center gap-1" onClick={() => toggleRecipeOrigin('halwa')}>
<span className="material-symbols-outlined text-[16px]">history_edu</span> Origins
            </button>
<a className="px-space-md py-1.5 bg-primary hover:bg-primary-container text-on-primary rounded text-label-sm font-label-sm uppercase transition-colors" href="#reservation-section">
              Order at Table
...
<div className="hidden bg-surface p-space-lg rounded-xl shadow-xl space-y-space-sm border-l-4 border-secondary" id="origins-modal">
<div className="flex items-center justify-between">
<h4 className="font-headline-sm text-headline-sm text-primary font-bold" id="origins-title">Recipe Provenance</h4>
<button className="text-on-surface-variant hover:text-primary" onClick={() => closeOriginsModal()}>
<span className="material-symbols-outlined">close</span>
</button>
</div>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed" id="origins-desc"></p>
</div>
</div>
</section>
  );
