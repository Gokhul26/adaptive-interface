...
<div className="bg-surface-container-low p-space-xl rounded-xl shadow-sm space-y-space-md flex flex-col justify-between">
...
<div className="group relative h-64 overflow-hidden rounded shadow-sm">
